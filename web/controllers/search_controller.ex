defmodule DreadnoughtHangar.SearchController do
  ...
  @doc """
  Performs a search on ship, weapons, perks, and abilities based on their name.
  """
  def search(conn, %{"search" => %{"query" => query}}) do
    ...
    render(conn, "search_results.html", ships: ships, weapons: weapons, abilities: abilities, perks: perks)
  end
end
